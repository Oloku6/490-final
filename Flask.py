...
def test_new_model(prompt):
    try:
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {'role': 'system', 'content': 'You are a helpful assistant that assists with Python and C++ (coding) for Morgan State students. You also give more information about the ciriculums and majors based off this website: https://www.morgan.edu/academicprograms'},
